...
extension AccountSummaryViewController {
    ...
    private func setupRefreshControl() {
        refershControl.tintColor = appColor
        refershControl.addTarget(self, action: #selector(refreshContent), for: .valueChanged)
...
extension AccountSummaryViewController {
    ...
    private func displayError(_ error: NetworkError){
        let tittleAndMessage = titleAndMessage(for: error)
        self.showErrorAlert(title: tittleAndMessage.0, message: tittleAndMessage.1)
    }
