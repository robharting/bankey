...
//  Bankey
//
//  Created by Harting, R.P.G. (Rob) on 28/11/2025.
//
...
extension AccountSummaryCell {
    ...
    private func setup() {
        ...
        balanceAmountLabel.text = "$1000,888.63"
        ...
        contentView.addSubview(balanceStackView) // important! add to contentView
    ...
    private func layout() {
        NSLayoutConstraint.activate([
            ...
            nameLabel.topAnchor.constraint(equalToSystemSpacingBelow: underlineView.bottomAnchor, multiplier: 2), // multiplier 1 is 8pts -> 2 is 16pts
